/*
let requestURL = 'JSON/mark.json';
let requestTraje = new XMLHttpRequest();
requestTraje.open('GET', requestURL);
requestTraje.responseType = 'text';
requestTraje.send();
requestTraje.onload = function() {
    const mark = request.response;
